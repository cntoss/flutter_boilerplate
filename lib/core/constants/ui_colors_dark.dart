...
class UIColorsDark {
  ...
  /// Color(0xFF12162D)
  /// ```
  static const Color appBarPrimary = Color(0xFF12162D);

  /// Primary Appbar Background
  ///  ```
  /// Color(0xFF242B41)
  /// ```
  static const Color appBarSecondary = Color(0xFF242B41);

  /// Primary Scaffold Color
  ///  ```
  /// Color(0xFF12162D)
  /// ```
  static const Color backgroundPrimary = Color(0xFF12162D);

  /// Secondary Scaffold Color
  ///  ```
  /// Color(0xFF242B41)
  /// ```
  static const Color backgroundSecondary = Color(0xFF242B41);
  ...
  /// Color(0xFFA8CBFF)
  /// ```
  static const Color inputBorderDisabled = Color(0xFFACACAC);
  ...
  /// Color(0xFFE9E9E9)
  /// ```
  static const Color textPrimary = Color(0xFFE9E9E9);
  ...
  /// Color(0xFF12162D)
  /// ```
  static const Color white = Color(0xFF12162D);
}

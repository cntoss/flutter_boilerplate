...
const UserCollectionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'enabledBiometric': PropertySchema(
      id: 2,
      name: r'enabledBiometric',
      type: IsarType.bool,
    ),
    r'isRemember': PropertySchema(
      id: 3,
      name: r'isRemember',
      type: IsarType.bool,
    ),
...
void _userCollectionSerialize(
  ...
  writer.writeBool(offsets[2], object.enabledBiometric);
  writer.writeBool(offsets[3], object.isRemember);
...
UserCollection _userCollectionDeserialize(
  ...
  final object = UserCollection(
    ...
    employeeID: reader.readLongOrNull(offsets[1]),
    enabledBiometric: reader.readBoolOrNull(offsets[2]),
    id: id,
    isRemember: reader.readBoolOrNull(offsets[3]),
...
extension UserCollectionQueryFilter
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      enabledBiometricIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'enabledBiometric',
      ));
    });
  }

  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      enabledBiometricIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'enabledBiometric',
      ));
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      enabledBiometricEqualTo(bool? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'enabledBiometric',
        value: value,
...
extension UserCollectionQuerySortBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy>
      sortByEnabledBiometric() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enabledBiometric', Sort.asc);
    });
  }

  QueryBuilder<UserCollection, UserCollection, QAfterSortBy>
      sortByEnabledBiometricDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enabledBiometric', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy>
      sortByIsRemember() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemember', Sort.asc);
    });
  }

  QueryBuilder<UserCollection, UserCollection, QAfterSortBy>
      sortByIsRememberDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemember', Sort.desc);
    });
  }
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct>
      distinctByEnabledBiometric() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'enabledBiometric');
    });
  }

  QueryBuilder<UserCollection, UserCollection, QDistinct>
      distinctByIsRemember() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isRemember');
    });
  }
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, int?, QQueryOperations> employeeIDProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, bool?, QQueryOperations>
      enabledBiometricProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'enabledBiometric');
    });
  }

  QueryBuilder<UserCollection, bool?, QQueryOperations> isRememberProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isRemember');
    });
  }
